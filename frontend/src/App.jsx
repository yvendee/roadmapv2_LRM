...
function Layout({ isDark, setIsDark, collapsed, setCollapsed }) {
  ...
  const isLoginPage = location.pathname === '/' || location.pathname === '/forgot-password' || location.pathname === '/create-user' || location.pathname === '/create-organization';
  ...
  return (
    ...
    <div className="flex min-h-screen min-w-screen bg-white dark:bg-gray-900 text-black dark:text-white">
      ...
      {showMainLayout && location.pathname !== '/messaging' && (
        <ChatHead />
      )}
